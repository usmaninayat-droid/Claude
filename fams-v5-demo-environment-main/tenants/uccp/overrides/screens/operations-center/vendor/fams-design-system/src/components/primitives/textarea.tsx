    ...
    return (
      <div className={cn('flex flex-col gap-1.5', containerClassName)}>
        ...
        <textarea
          ...
          className={cn(
            'min-h-[80px] w-full rounded-md border border-border bg-input-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground transition-shadow outline-none',
