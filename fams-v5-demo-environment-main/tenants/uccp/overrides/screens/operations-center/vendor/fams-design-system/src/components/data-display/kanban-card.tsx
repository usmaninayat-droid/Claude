        ...
        <div className={cn(
          ...
          <div className="flex w-full flex-col items-start gap-1.5">
              ...
              <div className="flex min-w-0 flex-wrap items-center gap-1.5">
                {ticketId ? (
                  <div className="inline-flex h-5 items-center gap-1 rounded-[2px] px-2 py-1 bg-border">
                    ...
                    <span className="text-[12px] font-semibold uppercase leading-none text-muted-foreground">
                      {ticketId}
                    </span>
                  </div>
                ) : null}
            ...
            <div className="flex w-full flex-col items-start gap-2 mt-1">
              {title ? (
                <p className="w-full text-[16px] font-bold leading-snug text-foreground [overflow-wrap:anywhere]">
                  {title}
                </p>
              ) : null}
                ...
                <div className="flex w-full flex-col items-start gap-1.5">
                  {metadataFields.map((field, i) => (
                    <div key={i} className="inline-flex max-w-full items-center gap-1.5">
                      ...
                      <span className="truncate text-[13px] font-medium leading-[18px] text-muted-foreground">
                        {field.value}
                      </span>
                    </div>
                  ))}
