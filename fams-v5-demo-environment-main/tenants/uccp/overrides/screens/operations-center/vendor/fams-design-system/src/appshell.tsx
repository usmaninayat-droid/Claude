 ...
 * Workshop (Truemax) / Sales (Acme) / EAD RMS (navy) / Cement Delivery /
 * Ducon Industries (amber) / Generator Monitoring (violet).
 */
const container = document.getElementById('root');
if (!container) throw new Error('#root not found');
createRoot(container).render(
  <AppShell apps={[workshopApp, salesApp, eadRmsApp, cementApp, duconApp, generatorApp]} />
);
