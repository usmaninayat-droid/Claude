...
export interface SideNavProps {
   ...
   * below it (e.g. a Home / Launch Pad item — Figma "FAMS Landing" `5442:2372`,
   * where the bracket holds Inbox + Home). Each renders with the inbox button
   * style and supports its own `notificationDot`/`active` state.
   */
...
export function SideNav({
  ...
  // Inbox + any pinned items share ONE divider bracket (Figma 5442:2372).
...
/* Inbox bracket — top of the app group, bracketed by 40px hairline dividers
   ...
   Home) stacked below it, all inside the same divider pair. */
