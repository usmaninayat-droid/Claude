            ...
            <li key={label} className="flex w-[92px] flex-col items-center text-center">
              <div className="flex w-full items-center">
                ...
                <button
                  ...
                  className={cn(
                    'grid size-6 shrink-0 cursor-pointer place-items-center rounded-full border-2 text-[10px] font-bold transition-colors',
                    done
              ...
              <span className={cn('mt-1.5 px-1 text-[10px] leading-tight', isCurrent ? 'font-semibold text-primary' : done ? 'text-foreground' : 'text-muted-foreground')}>
                {label}
              </span>
            </li>
          );
