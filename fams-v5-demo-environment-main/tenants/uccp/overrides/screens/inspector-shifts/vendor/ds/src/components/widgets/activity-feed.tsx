            ...
            e.kind === 'system' ? (
              <div key={e.id} className="flex items-center gap-2.5">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-1.5 text-body-sm">
                  {e.author ? <span className="shrink-0 font-bold uppercase tracking-wide text-foreground">{e.author}</span> : null}
            ...
            <div key={e.id} className="flex gap-2.5">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline justify-between gap-2">
                  <span className="truncate text-body-sm font-bold uppercase tracking-wide text-foreground">{e.author}</span>
