...
export function ChartTooltip({
  ...
  return (
    <div
      className="pointer-events-none rounded-md border border-popover/50 bg-popover px-3 py-2 text-xs text-popover-foreground shadow-lg"
      style={{ minWidth: 120 }}
      role="tooltip"
    >
        ...
        {payload.map((item, idx) => {
          ...
          return (
            <li
              ...
              className="flex items-center justify-between gap-3 text-[12px] leading-tight tabular-nums"
            >
