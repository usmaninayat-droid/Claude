  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-hidden rounded-[8px] border border-border">
        <div className="grid grid-cols-[90px_1fr_110px_90px_120px] gap-2 border-b border-border bg-muted/40 px-3 py-2 text-caption font-semibold uppercase tracking-wide text-muted-foreground">
              ...
              left: [
                {
                  ...
                  value: (
                    <span className="rounded-[2px] px-2 py-1 text-caption font-semibold uppercase" style={{ background: live.typeConfig?.bg, color: live.typeConfig?.text }}>
                      {String(live.type ?? '')}
                    </span>
                  ),
                },
              ...
              <div className="flex w-full items-start gap-4">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-4">
                  ...
                  <TaskInfoRow
                    label="Status"
                    value={
                      <span className="rounded-[4px] px-1.5 py-[3px] text-caption font-semibold uppercase text-white" style={{ background: asset ? statusPillBg(asset.status) : '#98a2b3' }}>
                        {asset?.status ?? 'Active'}
                      </span>
                    }
                  />
