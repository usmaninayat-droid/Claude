...
export function IconsPage() {
  ...
  return (
    <div>
      ...
      <Sec id="file-type" title="File Type" count={`${FILE_TYPES.length} types`} desc="The real Figma File Type artwork — illustrated document page + colour-coded extension corner, loaded per extension (falls back to a generic Default glyph for anything unmapped).">
