...
import { Maximize2, Plus, Minus, Layers, LocateFixed } from 'lucide-react';
...
export interface MapWidgetProps {
  ...
  onFullscreen?: () => void;
  /** Show locate/fit-to-content toggle (bottom-right, above zoom). Default false. */
  showLocate?: boolean;
  onLocate?: () => void;
    ...
    >
      ...
      {statusBadge ? (
        <div className="absolute left-3 top-3 z-10">
          <span
            className={cn(
              'inline-flex items-center rounded px-2 py-1 text-caption font-semibold uppercase tracking-wide border',
      ...
      {/* Zoom + fullscreen + locate controls — bottom-right */}
      {showZoomControls || showFullscreen || showLocate ? (
