...
export function ViewTabs({
  ...
  return (
    <div className={cn('flex items-center gap-1 border-b border-border bg-card pl-2', className)}>
        ...
        {tabs.map((t) => {
          ...
          return (
            <div
              key={t.id}
              className={cn(
                'group inline-flex items-center gap-1 rounded-t-md px-3 py-2 text-body-sm transition-colors cursor-pointer',
                active
      ...
      {modified ? (
        <div className="flex items-center gap-2 pr-2 text-caption">
