      ...
      <div className="flex w-full flex-col gap-1">
        ...
        >
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center">
            <span
              className="pointer-events-none text-caption font-medium uppercase tracking-wide text-muted-foreground"
            ...
            <input
              ...
              {...inputProps}
              className={cn(
                'mt-0.5 w-full border-none bg-transparent p-0 text-body-sm font-medium text-foreground outline-none placeholder:text-muted-foreground/60',
              )}
            />
          </div>
          {showChevron ? (
