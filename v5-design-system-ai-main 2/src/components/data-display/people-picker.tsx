      ...
      <PopoverTrigger asChild>
        ...
        >
          {chosen.length ? (
            ...
            <span className="inline-flex size-6 shrink-0 items-center justify-center rounded-full border-2 border-dashed border-muted-foreground/50 text-caption font-bold text-muted-foreground">
              ?
            </span>
          )}
