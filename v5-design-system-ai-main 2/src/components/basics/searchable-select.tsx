...
function SearchableSelectRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="flex w-full items-center gap-2.5 rounded-md px-2 py-2 text-left text-body-sm outline-none transition-colors hover:bg-muted focus-visible:bg-muted"
    >
      {multiple ? (
